locals {
  ...
  # General variables
  #---------------------------------------------------------------------
  prefix = "log4j-shell-poc"

  #---------------------------------------------------------------------
  # Github repo variables
  #---------------------------------------------------------------------
  github_site      = "jmvigueras"
  github_repo_name = local.prefix
 
  git_author_email = "jmvigueras@gmail.com"
  git_author_name  = "jmvigueras"
  ...
  dockerhub_image_name    = "log4j-shell-poc"
  dockerhub_image_version = "1"
  ...
  aws_ssm_param_path = "/fgt-k8s-cicd"
  aws_ssm_secrets = {
  ...
  #---------------------------------------------------------------------
  fgt_ssm_param_path = "/fgt-k8s-cicd"
  fgt_ssm_secrets = {
    HOST        = "fgt_host"
    TOKEN       = "fgt_api_key"
